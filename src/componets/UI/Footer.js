...
const Footer = () => {
  return (
    <footer class="bg-[#263238] dark:bg-gray-900 w-full px-[6%] py-[2%] ">
      <div class="  ">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="https://flowbite.com/" class="flex items-center">
              <img src={img} class=" w-14 pr-2" alt="FlowBite Logo" />
              <span class="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-white ">News Update</span>
            </a>
          </div>
